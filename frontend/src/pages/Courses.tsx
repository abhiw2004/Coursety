...
export default function Courses() {
  ...
  if (loading) return <div className={styles.center}>Loading courses...</div>
  if (error) return <div className={styles.error}>Error: {error}</div>
  if (!courses.length) return <div className={styles.center}>No courses yet. Check back later!</div>
